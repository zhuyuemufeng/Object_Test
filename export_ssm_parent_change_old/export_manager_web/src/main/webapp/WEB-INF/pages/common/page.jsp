...
<div class="pull-left">
    <div class="form-group form-inline">
        ...
        <select class="form-control" onchange="sizeSelect()" id="selectSize">
...
<form id="pageForm" action="${param.pageUrl}" method="post">
    <input type="hidden" name="page" id="pageNum">
    <input type="hidden" name="size" value="${page.pageSize}" id="changeSize">
</form>
<script>
    function sizeSelect() {
        var select = document.getElementById("selectSize");
        var change = document.getElementById("changeSize");
        change.value = select.options[select.selectedIndex].value;
