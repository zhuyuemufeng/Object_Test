...
<script>
    ...
    function updateExport() {
        var id = getCheckId()
        if(id) {
                location.href="${ctx}/cargo/export/updateState.do?id="+id+"&page=${page.pageNum}&size=${page.pageSize}";
        }else{
            alert("请勾选待处理的记录，且每次只能勾选一个")
        }
    }
                ...
                <div class="pull-left">
                    <div class="form-group form-inline">
                        <div class="btn-group">
                            ...
                            <button type="button" class="btn btn-default" title="状态更新" onclick="updateExport();"><i class="fa fa-refresh"></i> 状态更新</button>
                        </div>
                    </div>
                </div>
                    ...
                    <c:forEach items="${page.list}" var="o" varStatus="status">
                        <tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
                            ...
                            <td>
                                ...
                                <c:if test="${o.state==3}"><font color="#cd853f">待审核</font></c:if>
                            </td>
                            <td>
