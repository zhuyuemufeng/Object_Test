            ...
            <div class="table-box">
                ...
                <div class="pull-left">
                    <div class="form-group form-inline">
                        <div class="btn-group">
                            <button type="button" class="btn btn-default" title="新增" onclick='location.href="${ctx}/cargo/packing/toAdd.do"'><i class="fa fa-file-o"></i> 新增</button>
                            <button type="button" class="btn btn-default" title="编辑" onclick='update()'><i class="fa  fa-eye-slash"></i> 编辑</button>
                ...
                <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                    <thead>
                    <tr>
                        <td><input hidden type="checkbox" name="selid" onclick="checkAll('id',this)"></td>
                    ...
                    <c:forEach items="${page.list}" var="o" varStatus="status">
                        <tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
                            ...
                            <td>
                                ...
                                <c:if test="${o.state==1}">
                                    <a href="${ctx }/cargo/packing/toLoad.do?id=${o.packingListId}">[下载]</a>
                                </c:if>
                            </td>
                        </tr>
                    </c:forEach>
