        ...
        <div class="panel panel-default">
            ...
            <form id="editForm" action="/company/edit.do" method="post">
                ...
                <div class="row data-type" style="margin: 0px">
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" name="expirationDate" placeholder="到期时间" name="balance" id="expirationDate">
                    </div>

                    <div class="col-md-2 title"></div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="" name="" value="${company.balance}">
                    </div>
